...
<section class="wrapper">
	...
	1.1-Grupo Deltron no se responsabiliza por el desconocimiento de los términos de garantía del personal que entregue o recoja los productos en el área de Servicio al Cliente.<br>
	1.2-La garantía aplica sólo a la mercadería vendida por Grupo Deltron, no se extiende a terceros ni se responsabiliza por posibles daños a otra mercadería ni los producidos por el transporte de terceros y sólo se presta en nuestros centros de servicios.<br>
	1.3-La garantía no incluye ningún tipo de instalación. Dicho servicio tendrá un costo adicional.<br>
	1.4-En ningún caso Grupo Deltron se responsabiliza por el software u otros datos almacenados en la mercadería. Se recomienda realizar backups (copias de respaldo) en forma periódica. Grupo Deltron no se responsabiliza por posibles daños y/o perjuicios de cualquier naturaleza causados por fallas en la mercadería (a excepción de la propia mercadería). Es obligatorio que al ensamblar se realice un control de calidad antes de entregar el producto final.<br>
	1.5-El periodo de garantía del servicio de ensamblaje de computadoras es de un año y sólo cubre la mano de obra de la reparación. Esta garantía no cubre el software instalado u otra información instalada.<br>
	1.6-No se aceptarán cambios ni devoluciones por incompatibilidad con productos de otros proveedores ni por errores de compra, esto se encontrará sujeto a validación por el área de reclamos, así como a penalizaciones por gastos administrativos.<br>
	<br>
	<strong>2 -Lineamientos de los Productos en Garantía</strong><br><br>
	2.1-La mercadería debe ser remitida a nuestros centros de servicios debidamente protegida, con los accesorios completos, conforme fue despachada, en el caso de "cases" bastará traer la fuente de alimentación con su respectiva guía de remisión. En los casos que el producto sea de un lote se solicitará la guía de remisión para el ingreso del producto.<br>
	2.2-El cliente deberá indicar la falla específica de la mercadería al momento de entregarla. De no verificarse la falla descrita, la mercadería será devuelta. En el caso de envío de productos de provincia se deberá llenar el formato RMA especificando la falla del producto, el cual se encuentra colgado en el siguiente link:http://intra-www2.deltron.com.pe/images/envios/descargar_formato.html?.<br>
	2.3-La garantía de la mercadería no será válida en los siguientes casos: daño físico, etiquetas del fabricante o de Grupo Deltron adulteradas o removidas, evidencia de intento de reparación, evidencia de rayaduras o maltratos en las cubiertas plásticas, daños causados por fluctuaciones eléctricas externas, sobrecarga, mala instalación, cualquier elemento extraño (oxido, ácidos, líquidos, químicos, etc.), por desastres naturales o provocados (incendios, inundaciones, tormentas eléctricas, terremotos, etc.), por uso o almacenaje sin cumplir las especificaciones ambientales del fabricante.<br>
	2.4-La garantía no cubre accesorios, conectores, puertos de entrada y salida (paralelo, serial, etc.), o cabezales de impresoras. Así mismo no cubre consumibles y/o repuestos consumibles y componentes que se desgasten por el uso.<br>
	2.5-La recepción del producto, por parte de Servicio al Cliente, no implica un diagnostico definitivo y no garantiza la aplicación de la garantía del mismo, esto será validado por el especialista técnico. Por lo tanto, el cargo de recepción que se le entrega no garantiza la aplicación de la garantía del producto.<br>
	2.6-El cliente se encuentra en la obligación de ingresar al sistema listo (http://listo.deltron.com.pe/precargos) para conocer el status de su producto, en el caso que estos se encuentren en la categoría "LISTO PARA RECOGER" y superen el tiempo de almacenamiento de 30 días Grupo Deltron podrá disponer de los productos según como considere conveniente, siendo el producto declarado en ABANDONO.<br>
	2.7-Los productos enviados a nuestras oficinas que no cumplan con los requisitos indicados o que no cuenten con la información completa no serán aceptados.<br>
	<br>
	<strong>3 -Tipos y Tiempos de Garantía</strong><br><br>
	3.1-Los tipos y períodos de garantía se especifican en la lista de precios, guía de remisión y ficha de producto en nuestra web. Consulte con su ejecutivo de ventas cualquier duda antes de realizar su compra.<br>
	3.2-La mercadería con código de garantía "W" (Garantía del representante en el Perú) descritos en la lista de precios y en la ficha del producto en nuestra web, se rigen por las condiciones de garantía de los mismos representantes y se canalizan a través de sus Centros de Servicio Autorizados (CSA).<br>
	3.3-La mercadería con código de garantía "X" (Consultar), "Y" (Garantía sólo del fabricante) y "Z" (No aplica), deberán ser tramitadas directamente con el fabricante.<br>
	3.4-La mercadería que no se encuentre especificada en los puntos 3.2 y 3.3, se manejará bajo las siguientes modalidades:<br>
	3.4.1-Atención Inmediata: Durante este plazo la mercadería podrá ser remplazada inmediatamente después de verificada la falla de fabricación. Los requisitos son:<br>
	3.4.1.1-Despachos locales (3 días útiles después de la compra).<br>
	3.4.1.2-Despachos a otras provincias (5 días útiles después de la compra).<br>
	3.4.2-Atención Regular: El remplazó se realizará en un tiempo máximo de 30 días calendarios posteriores al ingreso del producto.<br>
	3.5-La mercadería de remplazó podrá ser: reparada, remanufacturada u otro producto de características similares o superiores de la misma marca u otra; y será garantizada por el período restante de la garantía.<br>
	3.6-En caso de no disponer de stock del producto de remplazó en el plazo máximo de atención se emitirá una nota de crédito, con el precio actualizado del producto a la fecha de emisión de la nota de crédito. La emisión de la nota de crédito no aplica para los casos con solución de remplazó de producto.<br>
	<br>
	<br>
	Con el propósito de brindarles un mejor servicio en la atención de sus garantías y aclarar las posibles dudas, les invitamos a contactarse: Consultas Técnicas - email: soporte@deltron.com.pe<br><br>
	
	Consultas administrativas y de gestión de garantías - email: servicio.cliente@deltron.com.pe<br><br>
	
	Consultas sobre el estado de sus productos, ingresar al siguiente link: .http://listo.deltron.com.pe/precargos<br><br>
	
	Para mayor información visite nuestra página web www.deltron.com.pe www.deltron.com.pe
	Los términos y condiciones de garantías pueden ser modificados sin previo aviso. El cliente declara su consentimiento respecto a los términos de la presente es libre y voluntario, sin que medie dolo, error ni vicio alguno que pudiera invalidarla parcial totalmente.<br>
