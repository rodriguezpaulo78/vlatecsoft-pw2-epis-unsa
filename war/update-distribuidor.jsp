...
<% 	PersistenceManager pm = PMF.get().getPersistenceManager();
	...
	<THEAD><tr>
		...
		<th WIDTH="150" class="table-sortable:default"> Nombre </th>
		<th WIDTH="80" class="table-sortable:numeric" > DNI </th>
		<th WIDTH="200" class="table-sortable:default"> Email </th>
		<th WIDTH="80" class="table-sortable:numeric" > Telefono </th>
		<th WIDTH="80" class="table-sortable:default"> Usuario </th>
		<th WIDTH="100" class="table-filterable table-sortable:default"> Estado </th>
		<th WIDTH="70"> Opcion </th>
	</tr></THEAD><tbody>
		<% for(int i=0;i<p.size();i++){ %>
		<% String estado= (p.get(i).getContest())? "Activo":"No Activo"; %>
			<form action="updateDistribuidor" method="post">
