...
<p id="footer2"></p>
<p id="footer3">Si no eres redireccionado automáticamente pulsa en el siguiente enlace : <a href="login-cliente.jsp"> Inicio de Sesión de Clientes.</a></p>
