...
<div class="top2">
	<div class="page-title">
		<div class="container">
			<div class="h1color"><h1>Eliminar Mensaje</h1></div>
		</div>
		<div class="container">
			<div class="datagrid1">
...
<% 	PersistenceManager pm = PMF.get().getPersistenceManager();
	...
	<tr>
		...
		<td colspan="4" style="color:white;text-align:center;">Pagina <span id="t1page"></span>&nbsp;de <span id="t1pages"></span></td>
		<td class="table-page:next" style="color:white;text-align:center;cursor:pointer;">Siguiente</td>
		
	</tr>
	<tr>
		<td colspan="6"style="color:white;text-align:center;"><span id="t1filtercount"></span>&nbsp;of <span id="t1allcount"></span>&nbsp;rows match filter(s)</td>
</tfoot>
